...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product">
      ...
      <h3 id="pd-name">${product.title.slice(0, 20)}</h3>
      <p class="category-rating">Category: ${product.category}</p>
      <p class="category-rating">Rating: ${product.rating.rate}
      <i class="icons fas fa-star"></i>
      <i class="icons fas fa-star"></i>
      <i class="icons fas fa-star"></i>
      <i class="icons fas fa-star-half-alt"></i>
      <i class="icons far fa-star"></i>
